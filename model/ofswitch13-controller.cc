...
int
OFSwitch13Controller::SendToSwitch (SwitchInfo swtch, 
  ...
  if (argc > 1) 
    {
      ...
      msg->instructions = (ofl_instruction_header**)xmalloc (inst_num * 
          sizeof (ofl_instruction_header*));
  ...
  if (argc > 1) 
    {
      ...
      msg.buckets = (ofl_bucket**)xmalloc (buckets_num * 
          sizeof (ofl_bucket *));
  ...
  if (argc > 1) 
    {
      ...
      msg.bands = (ofl_meter_band_header**)xmalloc (bands_num * 
            sizeof (ofl_meter_band_header*));
